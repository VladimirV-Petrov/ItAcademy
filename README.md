...
Module 19
---
Необходимо создать программу, которая параллельно выполняет различные операции с массивом данных. Программа должна использовать несколько потоков для выполнения различных вычислений.   
Условия задачи: 
  Массив: Имеется один большой массив из 100 элементов, заполненный случайными числами от 1 до 100.   
    Создайте три потока:   
      Первый поток должен находить сумму всех элементов массива.   
      Второй поток должен находить максимальный элемент массива.   
      Третий поток должен находить минимальный элемент массива.   
Главный поток: Главный поток программы должен дожидаться завершения всех потоков и вывести результаты: сумму, максимальный и минимальный элементы.   
Синхронизация: Для защиты данных используйте мьютексы или другие механизмы синхронизации, чтобы избежать проблем с одновременным доступом к переменным результата.  
